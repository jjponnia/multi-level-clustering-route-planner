...
def config(args=None):
    ...
    # data
    parser.add_argument('--target_size', type=int, default=5, help="The targets amount")
    ...
    parser.add_argument('--agent_amount',type=int,default=1,help="agent amount")
    parser.add_argument('--meta_agent_amount', type=int, default=1, help="meta agent amount")
    parser.add_argument('--number_of_gpu', default=1, help="number of GPUs")
